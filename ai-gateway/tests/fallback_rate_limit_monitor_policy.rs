...
fn retry_after_header_overrides_default() {
    ...
    let duration = fallback_bridge::resolved_rate_limit_restore_after(&cfg, Some(10));
...
fn no_header_uses_policy_default() {
    ...
    let duration = fallback_bridge::resolved_rate_limit_restore_after(&cfg, None);
...
fn compat_mode_matches_legacy_test_constants() {
    ...
    let duration = fallback_bridge::resolved_rate_limit_restore_after(&cfg, Some(2));
...
fn zero_retry_after_adds_buffer() {
    ...
    let duration = fallback_bridge::resolved_rate_limit_restore_after(&cfg, Some(0));
