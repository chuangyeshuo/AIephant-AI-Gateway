...
/// Breakdown of prompt cache write tokens (OpenAI-compatible extension).
#[derive(Debug, Deserialize, Serialize, Clone, PartialEq, Default)]
pub struct CacheWriteDetails {
    #[serde(rename = "write_5m_tokens")]
    pub write_5m_tokens: u32,
    #[serde(rename = "write_1h_tokens")]
    pub write_1h_tokens: u32,
}
...
pub struct PromptTokensDetails {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cache_write_details: Option<CacheWriteDetails>,
}
